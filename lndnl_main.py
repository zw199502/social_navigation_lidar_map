...
def eval_policy(policy, eval_or_test_env, current_steps, 
    ...
    for i in range(eval_episodes):
        ...
        lidar_state, robot_goal_state  = eval_or_test_env.reset(eval=True, save_data=if_save_data)
...
def main():
    ...
    parser.add_argument("--load_test_model", type=str, default="step_1880000_success_86")
